...
import { SlideTwoItemModel } from './components/slide-two-item/slide-two-item.component';
declare var $: any;
@Component({
...
export class SlideTwoComponent implements OnInit, OnChanges, AfterViewChecked {
  @Input() dataList: SlideTwoItemModel[];
